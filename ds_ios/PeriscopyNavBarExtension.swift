...
extension UINavigationBar{
    ...
    func stripeImage()->UIImage {
        ...
        let colors:CFArray = [gradientColor.cgColor, UIColor.clear.cgColor] as CFArray
        
        
        let gradient = CGGradient(colorsSpace: CGColorSpaceCreateDeviceRGB(), colors: colors, locations: [0, 0.86])
