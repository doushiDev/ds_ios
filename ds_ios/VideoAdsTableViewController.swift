...
//        self.navigationController?.title = "商品推广"
...
//        CCWebViewSController.showWithContro(self, withUrlStr: videoInfo.url, withTitle: videoInfo.title)

      
        
        let url = NSURL(string: videoInfo.url)
